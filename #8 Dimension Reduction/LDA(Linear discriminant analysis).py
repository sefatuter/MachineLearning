...
X_train_lda = lda.fit_transform(X_train, y_train) # Yine iki boyuta indirgiyor, Sınıflar arasındaki farkı maksimize eder.
X_test_lda = lda.transform(X_test)

# LDA dönüşümünden sonra gelen LR
...
# LDA sonrası ve actual data
cm4 = confusion_matrix(y_pred, y_pred_lda) 
print("LDA sonrası ve Orijinal")
print(cm4)
