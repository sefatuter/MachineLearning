...
# veri kümesi
# Reklamın başarısını ölçmeye çalışıyoruz
dataset = pd.read_csv('Social_Network_Ads.csv')
X = dataset.iloc[:, [2, 3]].values # id, cinsiyet yok
...
print(basari.mean())
print(basari.std()) # Standart sapma ne kadar düşükse o kadar iyidir.
...
# önce büyük adımlar denenebilir giant steps, baby steps
...
n_jobs: aynı anda çalışacak iş sayısı
...
eniyisonuc = grid_search.best_score_ # En iyi sonucu verir
eniyiparams = grid_search.best_params_
